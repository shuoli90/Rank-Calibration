...
if __name__ == '__main__':
    ...
    for file_name in file_names:
        ...
        if os.path.exists(f'../tmp/{model}_{dataset}_{args.correctness}.json'):
            scores = json.load(open(f'../tmp/{model}_{dataset}_{args.correctness}.json'))
        else:
            ...
            with open(f'../tmp/{model}_{dataset}_{args.correctness}.json', 'w') as f:
                json.dump(scores, f)
