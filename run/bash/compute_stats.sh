python compute_stats.py --model gpt-3.5-turbo --temperature 1.0 --dataset triviaqa --correctness rouge1
python compute_stats.py --model gpt-3.5-turbo --temperature 1.0 --dataset triviaqa --correctness meteor
python compute_stats.py --model gpt-3.5-turbo --temperature 1.0 --dataset triviaqa --correctness rouge
